...
$query_Rs = "SELECT * FROM DATOS WHERE DNI = DNI "; 
...
<td width="105" class="tit-verde">DNI</td>

<td width="90" class="tit-verde">APELLIDO Y NOMBRE</td>

<td width="64" class="tit-verde">LEGAJO</td>

<td width="95" class="tit-verde">Localidad </td>
<!--
<td width="200"class="tit-verde">&nbsp;&nbsp;&nbsp;Competencia</td>

<td width="200"class="tit-verde">&nbsp;&nbsp;&nbsp;Residencia</td>
-->
<td width="164" class="enlaces"><div align="center" class="tit-verde">link</div></td>
...
<tr>
<td width="300" height="20" class="texto-chico"><div align="left" class="texto-comun"> <?php echo $row_Rs['DNI']; ?></div></td>

<td width="75" class="texto-chico"><div align="left" class="texto-comun"> <?php echo $row_Rs['APELLIDO_NOMBRE']; ?></div></td>

<td width="100" class="texto-chico"><div align="left" class="texto-comun"> <?php echo $row_Rs['LEGAJO']; ?></div></td>
 
<td width="100" class="texto-chico"><div align="left" class="texto-comun"> <?php echo $row_Rs['localidad1']; ?></div></td>
<!--
...
<!-- <a href="../secundaria/modulos/buscador/documentos/<?php// echo $row_Rs['documento'];?>" id="link" target="_blank">ABRIR / DESCARGAR</a>  -->
<a href="index.php?mod=buscador&acc=detalle_titular&LEGAJO=<?php echo $row_Rs['LEGAJO']; ?>" id="link">agregar </a>
