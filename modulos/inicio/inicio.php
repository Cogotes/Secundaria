...
$query_Rs = "SELECT * FROM datos_secu ORDER BY id DESC"; // SELECT Anterior
...
$query_Rs ="SELECT * FROM datos_secu WHERE escuela LIKE \"%$buscar%\" OR numero LIKE \"%$buscar%\" ORDER BY id DESC" ;
