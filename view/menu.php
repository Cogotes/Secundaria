...
<?php require_once"config/bbdd2.php";?>
 <?php $consulta1 = "SELECT * FROM datos_docente ORDER BY id DESC LIMIT 1" ; 
 $res1 = mysql_query($consulta1); ?>
 <?php while($row1=mysql_fetch_array($res1)): ?>    
 <a href="modulos/buscador/documentos/documento/<?php echo $row1['documento']; ?>" target="_blank"> Datos del Docente  </a> 
 <?php endwhile; ?>
...
<?php require_once"config/bbdd2.php";?>
 <?php $consulta1 = "SELECT * FROM hoja_secu ORDER BY id DESC LIMIT 1" ; 
 $res1 = mysql_query($consulta1); ?>
 <?php while($row1=mysql_fetch_array($res1)): ?>    
 <a href="modulos/buscador/documentos/documento/<?php echo $row1['documento']; ?>" target="_blank"> Hoja Informativa  </a> 
 <?php endwhile; ?>
 <hr>
 <!--**********************************************************-->
